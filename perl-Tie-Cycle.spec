...
Source0  : https://cpan.metacpan.org/authors/id/B/BD/BDFOY/Tie-Cycle-1.226.tar.gz
...
%prep
%setup -q -n Tie-Cycle-1.226
cd %{_builddir}
tar xf %{_sourcedir}/libtie-cycle-perl_1.225-1.debian.tar.xz
cd %{_builddir}/Tie-Cycle-1.226
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Tie-Cycle-1.226/deblicense/
...
cp %{_builddir}/Tie-Cycle-1.226/LICENSE %{buildroot}/usr/share/package-licenses/perl-Tie-Cycle/40c57ec429e15412b20d729324e54569471f58e6
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.32.1/Tie/Cycle.pm
