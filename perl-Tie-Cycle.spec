...
Source0  : https://cpan.metacpan.org/authors/id/B/BD/BDFOY/Tie-Cycle-1.228.tar.gz
...
%prep
%setup -q -n Tie-Cycle-1.228
cd %{_builddir}/Tie-Cycle-1.228
pushd ..
cp -a Tie-Cycle-1.228 buildavx2
popd
